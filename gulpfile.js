...
exports.default = series( series( html,php,cssSass, jsBabel, imgImagemin ), parallel( watchFiles, browserSyncFunc ) );
exports.build = series( html,php,cssSass, jsBabel, imgImagemin );